...
public class Main {
    ...
    static String oracleUserName = "extomato"; // replace with your uniqname
    static String password = "pyh20021129"; // replace with your Oracle password (default: eecsclass)
