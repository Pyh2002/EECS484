...
ALTER TABLE
    Photos
ADD
    CONSTRAINT fk_album FOREIGN KEY (album_id) REFERENCES Albums(album_id) ON DELETE CASCADE INITIALLY DEFERRED DEFERRABLE;
...
BEGIN IF :NEW.user1_id > :NEW.user2_id THEN temp := :NEW.user2_id;
